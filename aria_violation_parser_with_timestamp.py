    ...
    for filename in files:
        if filename.endswith((".json", ".jsonld", ".jsonId")):
            ...
            try:
                ...
                parsed_count += 1
                violation_log_per_file[filename] = {"1.3.1": 0, "4.1.2": 0}
                ...
                for section in ["violations", "incomplete", "inapplicable"]:
                    for violation in accessibility_data.get(section, []):
                        ...
                        for sc in target_criteria:
                            ...
                            if matched:
                                entry["matched_by"] = source
                                target_criteria[sc].append(entry)
                                violation_log_per_file[filename][sc] += 1
...
# Save summary stats with timestamp
...
summary_counts = {
    ...
    "run_time": run_time,
    "violations_by_file": violation_log_per_file
}
